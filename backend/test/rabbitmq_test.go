...
import (
	...
	"backend/app/utils/rabbitmq/hello_world"
	"backend/app/utils/rabbitmq/publish_subscribe"
	"backend/app/utils/rabbitmq/routing"
	"backend/app/utils/rabbitmq/topics"
	"backend/app/utils/rabbitmq/work_queue"
	_ "backend/bootstrap"
	"fmt"
