...
import (
	_ "backend/app/core/destroy" // 监听程序退出信号，用于资源的释放
	"backend/app/global/my_errors"
	"backend/app/global/variable"
	"backend/app/http/validator/common/register_validator"
	"backend/app/service/sys_log_hook"
	"backend/app/utils/casbin_v2"
	"backend/app/utils/gorm_v2"
	"backend/app/utils/snow_flake"
	"backend/app/utils/validator_translation"
	"backend/app/utils/websocket/core"
	"backend/app/utils/yml_config"
	"backend/app/utils/zap_factory"
	"log"
	"os"
)
