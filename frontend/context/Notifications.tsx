/*
 * @Author: Jacket-mzl
 * @Date: 2024-05-17 14:19:10
 * @LastEditors: Jacket-mzl
 * @LastEditTime: 2024-05-20 08:43:51
 * @Description:
 */
...
export function NotificationProvider(props: PropsWithChildren) {
  ...
  function Add(message: string, options?: NotificationOptions) {
    ...
    toast(message, {
      ...
      icon: <StatusIcon type={notification.type} />,
    });
  }
  ...
  return (
    <NotificationContext.Provider value={{ Add, Clear, notifications }}>
      ...
      <ToastContainer
        ...
        toastClassName={() =>
          "flex relative bg-base-300 rounded-xl justify-between overflow-hidden p-2 mb-2"
        }
